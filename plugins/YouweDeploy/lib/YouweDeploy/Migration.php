...
/**
 * Class YouweDeploy_Migration
 * @author Yasar Kunduz<y.kunduz@youwe.nl>
 */
class YouweDeploy_Migration extends YouweDeploy_Abstract
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    private $dumpFileName = 'migration.zip';
    /**
     * @var Zend_Config
     */
    public $config;
